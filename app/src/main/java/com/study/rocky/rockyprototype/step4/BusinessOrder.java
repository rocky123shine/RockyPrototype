...
//企业 订单
public class BusinessOrder extends AbsOrder {
//    订单名称 订单数量 企业名
private String order_name;
    ...
    @Override
    protected BusinessOrder clone() throws CloneNotSupportedException {
        BusinessOrder clone = (BusinessOrder) super.clone();
